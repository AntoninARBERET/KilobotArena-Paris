...
QT_MOC_LITERAL(5, 40, 12), // "queueCommand"
QT_MOC_LITERAL(6, 53, 17), // "sendQueuedCommand"
QT_MOC_LITERAL(7, 71, 11), // "sendCommand"
QT_MOC_LITERAL(8, 83, 11), // "sendProgram"
QT_MOC_LITERAL(9, 95, 4), // "open"
QT_MOC_LITERAL(10, 100, 5), // "close"
QT_MOC_LITERAL(11, 106, 4), // "read"
QT_MOC_LITERAL(12, 111, 10), // "resetDelay"
QT_MOC_LITERAL(13, 122, 8), // "readLoop"
QT_MOC_LITERAL(14, 131, 11) // "programLoop"

    },
    "SerialConnection\0readText\0\0status\0"
    "error\0queueCommand\0sendQueuedCommand\0"
    "sendCommand\0sendProgram\0open\0close\0"
    "read\0resetDelay\0readLoop\0programLoop"
};
...
void SerialConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->queueCommand((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 4: _t->sendQueuedCommand(); break;
        case 5: _t->sendCommand((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 6: _t->sendProgram((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 7: _t->open(); break;
        case 8: _t->close(); break;
        case 9: _t->read(); break;
        case 10: _t->resetDelay(); break;
        case 11: _t->readLoop(); break;
        case 12: _t->programLoop(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialConnection::readText)) {
                *result = 0;
            }
        }
        {
            typedef void (SerialConnection::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialConnection::status)) {
                *result = 1;
            }
        }
        {
            typedef void (SerialConnection::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialConnection::error)) {
                *result = 2;
            }
        }
    }
